...
+ (NSAttributedString *)legendForSeries1:(NSString *)series1
	...
	NSAttributedString *s1 = [[NSMutableAttributedString alloc] initWithString:series1
																	attributes:@{NSFontAttributeName : font, NSForegroundColorAttributeName : color1 ?: red}];
	NSAttributedString *space = [[NSAttributedString alloc] initWithString:@" "];
	NSAttributedString *versus = [[NSAttributedString alloc] initWithString:NSLocalizedStringWithDefaultValue(@"vs", @"APCAppCore", APCBundle(), @"vs", nil)
																 attributes:@{NSFontAttributeName : font, NSForegroundColorAttributeName : darkGray}];

	NSMutableAttributedString *legend = [[NSMutableAttributedString alloc] initWithAttributedString:space];
